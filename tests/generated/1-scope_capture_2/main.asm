...
main:
    ...
    mov rbx, [rbp-192] ; original closure _331___rgo_7374642f666d74__new to ____comptime_34_arg_clone_1 env_end pointer for clone
    mov rbx, rbx ; clone source env_end pointer
    mov r13, [rbx+24] ; load env size metadata for clone
    mov r14, [rbx+32] ; load heap size metadata for clone
    mov r12, rbx ; compute env base pointer for clone
...
__comptime_33_data:
    db "invalid format", 0
__comptime_35:
    dq __comptime_35_data, 14, 0, 0 ; data, byte length, heap base, heap size
__comptime_35_data:
    db "invalid format", 0
