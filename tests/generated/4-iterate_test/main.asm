...
iterate:
    ...
    mov rax, r12 ; copy _44_iterate_inner closure env_end to rax
    mov [rbp-40], rax ; store value
...
section .rodata
_45:
    dq _45_data, 4 ; string data pointer and byte length
_45_data:
    db "%d, ", 0
_49:
    dq _49_data, 4 ; string data pointer and byte length
_49_data:
    db "end", 10, 0
