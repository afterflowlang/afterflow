...
_7_bar_deep_release:
    ...
    mov rax, [r12-16] ; load _7_bar_release_field_0 env field
    mov [rbp-24], rax ; store value
...
section .rodata
_5:
    dq _5_data, 19 ; string data pointer and byte length
_5_data:
    db "msg1: %s, msg2: %s", 10, 0
_11:
    dq _11_data, 3 ; string data pointer and byte length
_11_data:
    db "bye", 0
_12:
    dq _12_data, 2 ; string data pointer and byte length
_12_data:
    db "hi", 0
