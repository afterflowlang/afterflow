...
bar:
    ...
    mov rbx, [rbp-320] ; original closure _344_bar to ____comptime_50_arg_clone_0 env_end pointer for clone
    mov rbx, rbx ; clone source env_end pointer
    mov r13, [rbx+24] ; load env size metadata for clone
    mov r14, [rbx+32] ; load heap size metadata for clone
    mov r12, rbx ; compute env base pointer for clone
...
section .rodata
_355:
    dq _355_data, 3, 0, 0 ; data, byte length, heap base, heap size
_355_data:
    db "bye", 0
_356:
    dq _356_data, 2, 0, 0 ; data, byte length, heap base, heap size
_356_data:
    db "hi", 0
