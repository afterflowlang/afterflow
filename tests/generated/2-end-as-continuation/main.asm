...
__rgo_737464__end__generic_0:
    ...
    mov rbp, rsp ; establish new frame base
    sub rsp, 16 ; reserve stack space for locals
    mov [rbp-8], rdi ; store _2___rgo_737464__end arg in frame
...
__rgo_737464__end__generic_0_unwrapper:
    ...
    mov [rbp-8], rdi ; store env_end arg in frame
    mov r12, [rbp-8] ; load operand
    mov rax, [r12-16] ; load _2___rgo_737464__end env field
...
global _5___rgo_737464__println
_5___rgo_737464__println:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 16 ; reserve stack space for locals
    ...
    syscall
    push r12 ; preserve current environment
    lea rdi, [rel _6] ; point to string literal
    call release_descriptor_ptr ; release owned descriptor
    pop r12 ; restore current environment
    ...
    leave ; unwind before jumping
    jmp rax
global _5___rgo_737464__println_unwrapper
_5___rgo_737464__println_unwrapper:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 16 ; reserve stack space for locals
    mov [rbp-8], rdi ; store env_end arg in frame
    ...
    pop rdi ; restore arg into register
    leave ; unwind before named jump
    jmp _5___rgo_737464__println
global _5___rgo_737464__println_deep_release
_5___rgo_737464__println_deep_release:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 32 ; reserve stack space for locals
    mov [rbp-8], rdi ; store env_end arg in frame
    ...
    mov rbx, 0 ; operand literal
    cmp rax, rbx
    jg _5___rgo_737464__println_release_skip_0
    mov rax, [r12-8] ; load _5___rgo_737464__println_release_field_0 env field
    mov [rbp-24], rax ; store value
    push r12 ; preserve current environment
    mov rdi, [rbp-24] ; load operand
    mov rax, [rdi+8] ; load closure release helper
    call rax ; recursively release closure
    pop r12 ; restore current environment
_5___rgo_737464__println_release_skip_0:
    mov rdi, r12 ; use pinned __env_end env_end pointer
    call release_heap_ptr ; release __env_end closure environment
    leave
    ret

global _5___rgo_737464__println_deepcopy
_5___rgo_737464__println_deepcopy:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 32 ; reserve stack space for locals
    mov [rbp-8], rdi ; store env_end arg in frame
    ...
    mov rbx, 0 ; operand literal
    cmp rax, rbx
    jg _5___rgo_737464__println_deepcopy_skip_0
    mov rcx, [r12-8] ; load field pointer
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate owned pointer
    mov [r12-8], rax ; store duplicated pointer
    mov [rbp-24], rax ; store value
_5___rgo_737464__println_deepcopy_skip_0:
    leave
    ret
...
__rgo_737464__println:
    ...
    lea rax, [_5___rgo_737464__println_unwrapper] ; load unwrapper entry point
    mov qword [r12+0], rax ; store unwrapper entry in metadata
    lea rax, [_5___rgo_737464__println_deep_release] ; load release helper entry point
    mov qword [r12+8], rax ; store release pointer in metadata
    lea rax, [_5___rgo_737464__println_deepcopy] ; load deep copy helper entry point
    mov qword [r12+16], rax ; store deep copy pointer in metadata
    mov qword [r12+40], 0 ; store num_remaining
    mov rax, r12 ; copy _7___rgo_737464__println closure env_end to rax
    mov [rbp-24], rax ; store value
...
main:
    ...
    mov qword [r12+32], rax ; heap size metadata
    lea rax, [__rgo_737464__end__generic_0_unwrapper] ; load unwrapper entry point
    mov qword [r12+0], rax ; store unwrapper entry in metadata
    lea rax, [__rgo_737464__end__generic_0_deep_release] ; load release helper entry point
    mov qword [r12+8], rax ; store release pointer in metadata
    lea rax, [__rgo_737464__end__generic_0_deepcopy] ; load deep copy helper entry point
    mov qword [r12+16], rax ; store deep copy pointer in metadata
    mov qword [r12+40], 0 ; store num_remaining
    mov rax, r12 ; copy _15___rgo_737464__end closure env_end to rax
    mov [rbp-16], rax ; store value
    mov rsi, 64 ; length for allocation
    mov rax, 9 ; mmap syscall
    xor rdi, rdi ; addr hint for kernel base selection
    ...
    mov qword [r12+16], rax ; store deep copy pointer in metadata
    mov qword [r12+40], 0 ; store num_remaining
    mov rax, r12 ; copy _16___rgo_737464__println closure env_end to rax
    mov [rbp-24], rax ; store value
    mov rax, [rbp-24] ; load operand
    push rax ; stack arg
...
section .rodata
_6:
    dq _6_data, 1, 0, 0 ; data, byte length, heap base, heap size
_6_data:
    db 10, 0
_10:
    dq _10_data, 6, 0, 0 ; data, byte length, heap base, heap size
_10_data:
    db "unused", 0
_9:
    dq _9_data, 4, 0, 0 ; data, byte length, heap base, heap size
_9_data:
    db " end", 0
_8:
    dq _8_data, 6, 0, 0 ; data, byte length, heap base, heap size
_8_data:
    db "before", 0
